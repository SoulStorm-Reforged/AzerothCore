...
void AddSC_generic_spell_scripts()
{
    ...
    RegisterSpellScriptWithArgs(spell_gen_mount, "spell_histoire_de_sergent", 0, 1356488, 2356488, 2356488, 2356488);
    RegisterSpellScriptWithArgs(spell_gen_mount, "spell_alunira", 0, 1447213, 2447213, 3447213, 4447213);
    RegisterSpellScriptWithArgs(spell_gen_mount, "spell_sabre_de_reve_du_soleil_couchant", 0, 1424479, 2424479, 2424479, 2424479);
    RegisterSpellScriptWithArgs(spell_gen_mount, "spell_une_trace_dans_la_ville", 0, 1408313, 2408313, 2408313, 2408313);
    RegisterSpellScriptWithArgs(spell_gen_mount, "spell_butineuse_dos-de-miel", 0, 1259741, 2259741, 3259741, 4259741);
    RegisterSpellScriptWithArgs(spell_gen_mount, "spell_loutreke_porteuse_de_loutremonde", 0, 1376912, 2376912, 2376912, 2376912);
    RegisterSpellScriptWithArgs(spell_gen_mount, "spell_zakhra", 0, 12000010, 22000010, 22000010, 22000010);
    RegisterSpellScriptWithArgs(spell_gen_mount, "spell_serre_du_vide_de_l’Étoile_noire", 0, 1179478, 2179478, 2179478, 2179478);
    RegisterSpellScriptWithArgs(spell_gen_mount, "spell_faucon_de_feu_corrompu", 0, 1097560, 2097560, 3097560, 4097560);
    RegisterSpellScriptWithArgs(spell_gen_mount, "spell_vaguerage_glaciaire", 0, 1289555, 2289555, 3289555, 4289555);
    RegisterSpellScriptWithArgs(spell_gen_mount, "spell_renes_de_corbeau_de_l_effroi", 0, 1155741, 2155741, 3155741, 4155741);
    RegisterSpellScriptWithArgs(spell_gen_mount, "spell_dragon-fae_enchante", 0, 1142878, 2142878, 3142878, 4142878);
    RegisterSpellScriptWithArgs(spell_gen_mount, "spell_cœur_des_aspects", 0, 1110051, 2110051, 3110051, 4110051);
    RegisterSpellScriptWithArgs(spell_gen_mount, "spell_wyrm_arborescent_de_bon_augure", 0, 1418286, 2418286, 3418286, 4418286);
    RegisterSpellScriptWithArgs(spell_gen_mount, "spell_jade_presage_de_bonheur", 0, 1369451, 2369451, 3369451, 4369451);
    RegisterSpellScriptWithArgs(spell_gen_mount, "spell_wyrm_eternel_ensorcele", 0, 1307932, 2307932, 3307932, 4307932);
    RegisterSpellScriptWithArgs(spell_gen_mount, "spell_feligre_mordore", 0, 1317177, 2317177, 3317177, 4317177);
    RegisterSpellScriptWithArgs(spell_gen_mount, "spell_yun_porte-bonheur", 0, 1308087, 2308087, 3308087, 4308087);
    RegisterSpellScriptWithArgs(spell_gen_mount, "spell_grand_wyrm_gorge_de_neant", 0, 1367676, 2367676, 3367676, 4367676);
    RegisterSpellScriptWithArgs(spell_gen_mount, "spell_cherchetoile_lumineux", 0, 1243512, 2243512, 3243512, 4243512);
    RegisterSpellScriptWithArgs(spell_gen_mount, "spell_siluride_merveilleux", 0, 1397406, 2397406, 3397406, 4397406);
    RegisterSpellScriptWithArgs(spell_gen_mount, "spell_couineur_l’entourloupeur", 0, 1308078, 2308078, 3308078, 4308078);
    RegisterSpellScriptWithArgs(spell_gen_mount, "spell_gorus_cochon_porte-bonheur", 0, 1290134, 2290134, 3290134, 4290134);
    RegisterSpellScriptWithArgs(spell_gen_mount, "spell_quilen_imperial", 0, 1124659, 2124659, 3124659, 4124659);
    RegisterSpellScriptWithArgs(spell_gen_mount, "spell_sabrerune_mystique", 0, 1180545, 2180545, 3180545, 4180545);
    RegisterSpellScriptWithArgs(spell_gen_mount, "spell_flambeciel_saphir", 0, 1347812, 2347812, 3347812, 4347812);
    RegisterSpellScriptWithArgs(spell_gen_mount, "spell_shu_zen_la_sentinelle_divine", 0, 1259395, 2259395, 3259395, 4259395);
    RegisterSpellScriptWithArgs(spell_gen_mount, "spell_incinerateur_fumecaille", 0, 1326390, 2326390, 3326390, 4326390);
    RegisterSpellScriptWithArgs(spell_gen_mount, "spell_reveur_sylvestre", 0, 1290132, 2290132, 3290132, 4290132);
    RegisterSpellScriptWithArgs(spell_gen_mount, "spell_tisse-reves_enchevetre", 0, 1359843, 2359843, 3359843, 4359843);
    RegisterSpellScriptWithArgs(spell_gen_mount, "spell_familier_vulpin", 0, 1290133, 2290133, 3290133, 4290133);
    RegisterSpellScriptWithArgs(spell_gen_mount, "spell_wen_lo_raz_des_rives", 0, 1359317, 2359317, 3359317, 4359317);
    RegisterSpellScriptWithArgs(spell_gen_mount, "spell_chariot_a_viande", 0, 1281554, 2281554, 2281554, 2281554);
    RegisterSpellScriptWithArgs(spell_gen_mount, "spell_brise-monde_d’obsidienne", 0, 1294197, 2294197, 3294197, 4294197);
    RegisterSpellScriptWithArgs(spell_gen_mount, "spell_serre-tempete_d’albatre", 0, 1302361, 2302361, 3302361, 4302361);
    RegisterSpellScriptWithArgs(spell_gen_mount, "spell_aile-tonnerre_d’albatre", 0, 1302362, 2302362, 3302362, 4302362);
    RegisterSpellScriptWithArgs(spell_gen_mount, "spell_glissedrake_du_gladiateur_d_obsidienne", 0, 1408977, 2408977, 3408977, 4408977);
    RegisterSpellScriptWithArgs(spell_gen_mount, "spell_glissedrake_du_gladiateur_verdoyant", 0, 1425416, 2425416, 3425416, 4425416);
    RegisterSpellScriptWithArgs(spell_gen_mount, "spell_drake_du_gladiateur_ecarlate", 0, 1377071, 2377071, 3377071, 4377071);
